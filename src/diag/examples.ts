...
const REFUND = "src/refund.rd";
const MONEY = "src/money.rd";
const API = "src/api.rd";
const REFUNDS_PATH = "src/payments/refunds.rd";
...
const examples = [
	{
		...
		span: { file: REFUND, line: 12, col: 5, len: 1 },
		docs: DIAGNOSTIC_REGISTRY.E0001.docs,
	},
	{
		code: "E0002",
		severity: "error",
		message: "unterminated string literal",
		span: { file: REFUND, line: 8, col: 18, len: 14 },
		suggest: [
			{
				kind: "insert-text",
				rationale: "close the string literal",
				at: { file: REFUND, line: 8, col: 32, len: 0 },
				insert: '"',
			},
		],
		docs: DIAGNOSTIC_REGISTRY.E0002.docs,
	},
	{
		code: "E0003",
		severity: "error",
		message: "invalid numeric literal `0x_`",
		span: { file: MONEY, line: 3, col: 14, len: 3 },
		docs: DIAGNOSTIC_REGISTRY.E0003.docs,
	},
	{
		code: "E0101",
		severity: "error",
		message: "expected `)` but found `,`",
		span: { file: REFUND, line: 4, col: 22, len: 1 },
		docs: DIAGNOSTIC_REGISTRY.E0101.docs,
	},
	{
		code: "E0102",
		severity: "error",
		message: "expected closing `}` for block opened at line 3",
		span: { file: REFUND, line: 9, col: 1, len: 0 },
		related: [
			{
				span: { file: REFUND, line: 3, col: 18, len: 1 },
				message: "opening `{` was here",
			},
		],
		docs: DIAGNOSTIC_REGISTRY.E0102.docs,
	},
	{
		code: "E0103",
		severity: "error",
		message: "unexpected end of input while parsing `fn` body",
		span: { file: REFUND, line: 42, col: 1, len: 0 },
		docs: DIAGNOSTIC_REGISTRY.E0103.docs,
	},
	{
		code: "E0104",
		severity: "error",
		message: "invalid effect row in signature: expected `!` followed by effect list",
		span: { file: REFUND, line: 1, col: 40, len: 1 },
		suggest: [
			{
				kind: "insert-text",
				rationale: "add an empty effect row for a pure function",
				at: { file: REFUND, line: 1, col: 40, len: 0 },
				insert: " ! {}",
			},
		],
		docs: DIAGNOSTIC_REGISTRY.E0104.docs,
	},
	{
		code: "E0201",
		severity: "error",
		message: "unknown identifier `chage_id`",
		span: { file: REFUND, line: 7, col: 12, len: 8 },
		suggest: [
			{
				kind: "rename",
	...
	},
	{
		...
		span: { file: REFUND, line: 20, col: 4, len: 6 },
		related: [
			{
				span: { file: REFUND, line: 5, col: 4, len: 6 },
	...
	},
	{
		...
		span: { file: REFUND, line: 2, col: 10, len: 8 },
		suggest: [
			{
				kind: "delete-span",
				rationale: "remove the unused import",
				span: { file: REFUND, line: 2, col: 1, len: 22 },
			},
		],
	...
	},
	{
		...
		severity: "error",
		message:
			"`refund_internal` is referenced by `src/api.rd` but not exported from `payments.refunds`",
		span: { file: API, line: 6, col: 18, len: 15 },
		suggest: [
			{
				kind: "insert-text",
				rationale: "add the symbol to the producing module's `exports` list",
				at: { file: REFUNDS_PATH, line: 3, col: 12, len: 0 },
				insert: ", refund_internal",
			},
		],
		docs: DIAGNOSTIC_REGISTRY.E0204.docs,
	},
	{
		code: "E0301",
		severity: "error",
		message:
			"function calls `write_file` which performs effect `Fs<write>`, but the signature declares `{}`",
		span: { file: REFUND, line: 11, col: 3, len: 10 },
		suggest: [
			{
				kind: "add-effect",
				rationale: "declare the effect in the function signature",
				at: { file: REFUND, line: 9, col: 40, len: 0 },
				insert: "Fs<write>",
			},
		],
	...
	},
	{
		...
		span: { file: REFUND, line: 9, col: 44, len: 10 },
		suggest: [
			{
				kind: "delete-span",
	...
	},
	{
		...
		span: { file: REFUND, line: 15, col: 5, len: 10 },
		related: [
			{
				span: { file: REFUND, line: 9, col: 40, len: 2 },
		...
		suggest: [
			{
				...
				at: { file: REFUND, line: 9, col: 42, len: 0 },
				insert: "Fs<write>",
			},
		],
	...
	},
	{
		...
		span: { file: REFUND, line: 14, col: 18, len: 8 },
	...
	},
	{
		...
		span: { file: REFUND, line: 18, col: 3, len: 5 },
		suggest: [
			{
				kind: "insert-text",
				rationale: "add a match arm for the missing variant",
				at: { file: REFUND, line: 22, col: 3, len: 0 },
	...
	},
	{
		...
		span: { file: REFUND, line: 24, col: 3, len: 12 },
		related: [
			{
				span: { file: REFUND, line: 21, col: 3, len: 1 },
	...
	},
	{
		...
		docs: DIAGNOSTIC_REGISTRY.E0602.docs,
	},
] as const satisfies readonly Diagnostic[];

export const DIAGNOSTIC_EXAMPLES: { readonly [K in DiagnosticCode]: Diagnostic } =
	Object.fromEntries(examples.map((d) => [d.code, d])) as {
		[K in DiagnosticCode]: Diagnostic;
	};
